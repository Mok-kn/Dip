...
class DetectionDistiller(BaseDetector):
    ...
    def forward_train(self, img, img_metas, **kwargs):
        ...
        student_rpn_output = self.student.rpn_head(feat)
        # student_rpn_output = self.student.bbox_head(feat)
        ...
        for item_loc in self.distill_cfg:
            ...
            for item_loss in item_loc.methods:
                ...
                student_loss[loss_name] = self.distill_losses[loss_name](student_feat,teacher_feat,student_rpn_output,kwargs['gt_bboxes'], img_metas)
